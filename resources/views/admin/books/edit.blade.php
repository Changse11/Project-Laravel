    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Form Edit Buku: {{ $book->judul }}</h6>
            </div>
            <div class="card-body">
                <form action="{{ route('books.update', $book) }}" method="POST">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="penerbit" id="penerbit" 
                                       ...
                                       value="{{ old('penerbit', $book->penerbit) }}" placeholder="Masukkan nama penerbit">
                                @error('penerbit')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="tahun_terbit" id="tahun_terbit" 
                                       ...
                                       value="{{ old('tahun_terbit', $book->tahun_terbit) }}" placeholder="2024" min="1900" max="{{ date('Y') }}">
                                @error('tahun_terbit')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="kategori" id="kategori" class="form-control @error('kategori') is-invalid @enderror">
                                    ...
                                    @foreach(['Pendidikan', 'Teknologi', 'Novel', 'Agama', 'Sejarah'] as $kat)
                                        <option value="{{ $kat }}" {{ old('kategori', $book->kategori) == $kat ? 'selected' : '' }}>
                                            {{ $kat }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="stok" id="stok" 
                                       ...
                                       value="{{ old('stok', $book->stok) }}" placeholder="0" min="0">
                                @error('stok')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="sinopsis" id="sinopsis" rows="5"
                                  ...
                                  placeholder="Masukkan sinopsis buku (opsional)">{{ old('sinopsis', $book->sinopsis) }}</textarea>
                        @error('sinopsis')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
